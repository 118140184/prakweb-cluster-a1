...
function tambah() {
    ...
    list.append(newList);
    i++;
    document.getElementById("judul").innerText = "Tambah Item";
    return false;
}
...
function edit(id) {
    ...
    document.getElementById("judul").innerText = "Edit Item";
}
...
function hapus(id) {
    ...
    document.getElementById("judul").innerText = "Hapus Item";
}
