...
$conn = mysqli_connect("localhost","root","","db_alfharidho") or die("Gagal Terhubung");
...
<table border="1" cellpadding="10" cellspacing="0">
	...
	<h4><a href="main.php" style="text-decoration: none;">Kembali ke beranda</a></h4>
